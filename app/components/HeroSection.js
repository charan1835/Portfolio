...
export default function HeroSection() {
  ...
  <User className="w-16 h-16 text-slate-400 dark:text-slate-400 light:text-slate-300" />
              ...
              <button
                ...
                className="absolute bottom-0 right-0 w-10 h-10 bg-purple-500 rounded-full flex items-center justify-center shadow-lg hover:bg-purple-600 transition-all duration-300"
              >
          ...
          >
            ...
            >
              I craft sleek, scalable, and user-friendly web applications powered by modern frameworks and APIs.
            </motion.p>
          </motion.div>
